...
function  listening(){
  ...
  app.use(express.static('feelingwebsite'));// will launch the index.html from this website , listen to the request to the "website" on the port and get the output
